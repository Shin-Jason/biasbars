...
def plot_word(word_data, word, max_frequency):
    ...
    # provided code to create x value lists for women and men
    ...
    # YOUR CODE HERE to create y_vals_women and y_vals_men, replacing these lists

    y_vals_women = [word_data[word][WOMEN_KEY][0], word_data[word][WOMEN_KEY][1], word_data[word][WOMEN_KEY][2]]
    y_vals_men = [word_data[word][MEN_KEY][0], word_data[word][MEN_KEY][1], word_data[word][MEN_KEY][2]]

    # YOUR CODE HERE to add a title to the plot
    plt.title("genius in Professor Reviews")
    # END OF YOUR CODE, the code below is provided for youpython3 biasbarsgraph.py smart
